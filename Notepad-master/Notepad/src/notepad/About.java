...
public class About extends JFrame implements ActionListener{
    ...
    About(){
        ...
        JLabel l3 = new JLabel("<html>Nitro-Text<br>Java Project 2024<br>2024 © All rights reserved<br><br>Nitro-Text is a word processing program, <br>which allows changing of text in a computer file.<br>Nitro-text is a simple text editor for basic text-editing program<br> which enables computer users to create documents. </html>");
